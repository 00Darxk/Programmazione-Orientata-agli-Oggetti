...
possibilità di creare più thread, oltre al Thread Main. 
...
Per aspettare le soluzioni parziali da parte dei thread invece si utilizza il metodo \verb|join()|. Ha una semantica complementare al metodo \verb|start()|, il metodo che 
lo invoca attende che il thread su cui è stato invocato termina la sua esecuzione prima di continuare la sua stessa esecuzione. 
